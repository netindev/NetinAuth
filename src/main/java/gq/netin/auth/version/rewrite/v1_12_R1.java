 ...
 *
 */
public class v1_12_R1 extends LoginListener {

	private static final MinecraftServer SERVER = ((CraftServer) Bukkit.getPlugin().getServer()).getServer();

	public v1_12_R1(NetworkManager networkManager, String player) {
		super(v1_12_R1.SERVER, networkManager);
	...
	public void e() {
		...
		EntityPlayer attemptLogin = v1_12_R1.SERVER.getPlayerList().attemptLogin(this, validProfile, this.hostname);
		if (attemptLogin != null) {
			this.networkManager.sendPacket(new PacketLoginOutSuccess(validProfile));
			v1_12_R1.SERVER.getPlayerList().a(this.networkManager,
					v1_12_R1.SERVER.getPlayerList().processLogin(validProfile, attemptLogin));
		}
	}
