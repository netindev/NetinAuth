...
import net.minecraft.server.v1_7_R2.LoginListener;
import net.minecraft.server.v1_7_R2.MinecraftServer;
import net.minecraft.server.v1_7_R2.NetworkManager;
import net.minecraft.server.v1_7_R2.PacketLoginOutSuccess;
 ...
 *
 */
public class v1_7_R2 extends LoginListener {

	private static final MinecraftServer SERVER = MinecraftServer.getServer();

	public v1_7_R2(NetworkManager networkManager, String player) {
		super(v1_7_R2.SERVER, networkManager);
	...
	public void c() {
		...
		EntityPlayer attemptLogin = v1_7_R2.SERVER.getPlayerList().attemptLogin(this, validProfile, this.hostname);
		if (attemptLogin != null) {
			this.networkManager.handle(new PacketLoginOutSuccess(validProfile), new GenericFutureListener[0]);
			v1_7_R2.SERVER.getPlayerList().a(this.networkManager,
					v1_7_R2.SERVER.getPlayerList().processLogin(validProfile, attemptLogin));
		}
	}
