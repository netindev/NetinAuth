 ...
 *
 */
public class v1_8_R2 extends LoginListener {

	private static final MinecraftServer SERVER = MinecraftServer.getServer();

	public v1_8_R2(NetworkManager networkManager, String player) {
		super(v1_8_R2.SERVER, networkManager);
	...
	public void c() {
		...
		EntityPlayer attemptLogin = v1_8_R2.SERVER.getPlayerList().attemptLogin(this, validProfile, this.hostname);
		if (attemptLogin != null) {
			this.networkManager.handle(new PacketLoginOutSuccess(validProfile));
			v1_8_R2.SERVER.getPlayerList().a(this.networkManager,
					v1_8_R2.SERVER.getPlayerList().processLogin(validProfile, attemptLogin));
		}
	}
